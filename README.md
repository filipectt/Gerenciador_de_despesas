...
A gestão de contas a pagar é um desafio financeiro. Ao lidar com um alto volume de faturas, é necessário priorizar pagamentos por vencimento e otimizar o uso da disponibilidade de caixa mensal. 
Fazer isso manualmente pode levar a atrasos e perda de oportunidades de desconto.
...
- google.colab.files: Necessário para o upload da planilha e o download do relatório final dentro do ambiente Colab.
